...
class RestController extends \Phalcon\Mvc\Controller
{
    ...
    */
    ...
    public function initialize()
    {
        ...
        //Membuat string menjadi capitalize (untuk Case Sensitive ex. Ubuntu)
        $camelcase          = $this->controllerName;
        $camel              = ucfirst(strtolower($camelcase));
    	$this->modelName    = $camel;//model
